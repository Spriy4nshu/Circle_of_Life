...
# Prey belief update which incorporates faulty drone setting
...
# Predator belief update which incorporates faulty drone setting
...
for x in range(30):
    ...
    for y in range(100):
        steps, win_condition, ndict = agent8a(ndict, clist)
        steps1 += steps
...
print(no_of_steps)
print('done')
data.to_csv('Agent08a.csv', index=False)
